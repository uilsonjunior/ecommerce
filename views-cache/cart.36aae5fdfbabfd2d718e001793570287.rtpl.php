                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a title="Remover este produto" class="remove" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove">×</a> 
                                        </td>
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Subtotal</th>
                                                <td><span class="amount">R$ <?php echo formatPrice($totais["vlprice"]); ?></span></td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                ...
                                                R$ <?php echo formatPrice($totais["vlprice"]+$cart["vlfreight"]); ?>
