											...
											<table class="shop_table">
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal </th>
														<td><span class="amount">R$ <?php echo formatPrice($totais["vlprice"]); ?></span>
														</td>
													</tr>
													<tr class="shipping">
														<th>Frete</th>
													...
													<tr class="order-total">
														...
														<td><strong><span class="amount">R$ <?php echo formatPrice($totais["vlprice"]+$cart["vlfreight"]); ?></span></strong> </td>
													</tr>
												</tfoot>
											</table>
											<div id="payment">
